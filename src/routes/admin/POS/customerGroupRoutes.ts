...
router.get('/',authorizePermissions("POS","View"),authorizePermissions("customer_group","View"), catchAsync(getallgroups));
router.get('/customers',authorizePermissions("POS","View"),authorizePermissions("customer_group","View"), catchAsync(getCustomers));
