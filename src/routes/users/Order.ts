...
import { createOrder, getMyOrders, getOrderDetails, getOrderStatusByRef, verifyPaymobPaymentStatus } from '../../controller/users/Order';
...
orderRoute.get("/status/:ref", catchAsync(getOrderStatusByRef));
