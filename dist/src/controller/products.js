...
const getProducts = async (req, res) => {
    const products = await products_1.ProductsModel.find({}).populate("brand_id", "name").populate("category_id", "name");
...
const getProductById = async (req, res) => {
    ...
    const product = await products_1.ProductsModel.findById(id).populate("brand_id", "name").populate("category_id", "name");
    if (!product)
