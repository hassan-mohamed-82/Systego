...
const createTransfer = async (req, res) => {
    ...
    const productInWarehouse = await Product_Warehouse_js_1.Product_WarehouseModel.findOne({ productId, warehouseId: fromWarehouseId });
    if (!productInWarehouse) {
        throw new index_js_1.NotFound("Product not found in the source warehouse");
    }
    if (productInWarehouse.quantity < quantity) {
        throw new BadRequest_js_1.BadRequest("Insufficient product quantity in the source warehouse");
    }
