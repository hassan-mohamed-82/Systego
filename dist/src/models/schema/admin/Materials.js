...
const materialSchema = new mongoose_1.default.Schema({
    ...
    category_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'CategoryMaterial', required: true },
...
exports.MaterialModel = mongoose_1.default.model("Material", materialSchema);
