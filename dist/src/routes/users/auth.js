...
authRoute.post("/complete-profile", (0, validation_1.validate)(auth_2.completeProfileSchema), auth_1.completeProfile);
// Profile Management
authRoute.put("/edit-profile/:id", authenticated_1.authenticated, (0, validation_1.validate)(auth_2.editProfileSchema), auth_1.editProfile);
