...
wishlistRoute.post('/add', Wishlist_1.addProductToWishlist);
wishlistRoute.delete('/remove', Wishlist_1.removeProductFromWishlist);
wishlistRoute.get('/', Wishlist_1.getUserWishlist);
wishlistRoute.get('/check/:productId', Wishlist_1.checkProductInWishlist);
