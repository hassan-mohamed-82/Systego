...
router.get("/:id", (0, catchAsync_1.catchAsync)(permission_1.getRoleById));
router.get("/:id/permissions", (0, catchAsync_1.catchAsync)(permission_1.getRolePermissions));
router.put("/:id", (0, catchAsync_1.catchAsync)(permission_1.updateRole));
router.delete("/:id", (0, catchAsync_1.catchAsync)(permission_1.deleteRole));
// Permissions
