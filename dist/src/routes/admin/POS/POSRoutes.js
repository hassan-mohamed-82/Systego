...
router.get("/sales/sales/pending/:sale_id", (0, haspremission_1.authorizePermissions)("POS", "View"), (0, catchAsync_1.catchAsync)(saleController_1.getSalePendingById));
router.get("/sales/:id", (0, haspremission_1.authorizePermissions)("POS", "View"), (0, catchAsync_1.catchAsync)(saleController_1.getSales));
