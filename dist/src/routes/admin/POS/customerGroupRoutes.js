...
router.get('/', (0, haspremission_1.authorizePermissions)("POS", "View"), (0, haspremission_1.authorizePermissions)("customer_group", "View"), (0, catchAsync_1.catchAsync)(customerGroupController_1.getallgroups));
router.get('/customers', (0, haspremission_1.authorizePermissions)("POS", "View"), (0, haspremission_1.authorizePermissions)("customer_group", "View"), (0, catchAsync_1.catchAsync)(customerGroupController_1.getCustomers));
