...
route.get("/", (0, haspremission_1.authorizePermissions)("purchase", "View"), (0, catchAsync_1.catchAsync)(Purchase_1.getPurchase));
route.get("/:id", (0, haspremission_1.authorizePermissions)("purchase", "View"), (0, catchAsync_1.catchAsync)(Purchase_1.getOnePurchase));
