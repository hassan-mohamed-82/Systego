...
route.get("/generate-barcode/:id", (0, catchAsync_1.catchAsync)(products_1.generateBarcodeImageController));
route.get("/products/generate-code", products_1.generateProductCode);
